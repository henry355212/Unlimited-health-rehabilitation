...
################################################################################################
button_start = Button(640, 360, 'imgs/start.png')
button_exit = Button(1100, 650, 'imgs/exit.png')
button_demo = Button(290, 360, 'imgs/demo.png')
button_score = Button(990, 360, 'imgs/score.png')
button_menu = Button(180, 650, 'imgs/menu.png')
button_again = Button(640, 650, 'imgs/again.png')
############################################
...
bg_score = pygame.image.load('imgs/bg_score.png')
...
# WIN_HEIGHT = 720  
        ...
        game_start_surface = pygame.transform.scale2x(pygame.image.load('assets/sprites/message.png').convert_alpha())
...
#                     pygame.display.update()
                ...
                # 進入demo
#############################################################
            demo_video = cv2.VideoCapture('imgs/demo_resized.mp4')
            while Demo:
